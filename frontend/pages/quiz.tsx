                ...
                setQuizData({
                    ...
                    "questions": [
                        ...
                        },
                        {
                            ...
                            "explanation": "Poliovirus enters the body through the gastrointestinal tract."
                        },
                        {
                        ...
                        {
                            "question": "Does infection or vaccination with one type of poliovirus provide immunity against the other types?",
                            "optionA": "Yes",
                            "optionB": "No",
                            "optionC": "It depends",
                            "correctAnswer": "No",
                            "explanation": "Infection or vaccination with one type of poliovirus does not provide immunity against the other types."
                        },
                        {
                            ...
                            "explanation": "Individuals who are exposed to the virus develop immunity through the production of antibodies."
                        }
                    ]
                })
            }
    ...
    return (
        <>
            ...
            <main className="grid grid-cols-2 px-10 my-10 gap-x-20">
                <div>
                    <h1 className="text-3xl font-bold mb-5">{articleName} - {sectionNames[0]} & {sectionNames[1]}</h1>
